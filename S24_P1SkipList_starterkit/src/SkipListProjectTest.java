...
public class SkipListProjectTest extends TestCase {
    ...
    public void testMain() throws IOException {
		...
		String[] testInput = { "solutionTestData/SyntaxTest.txt" }; // Type is array of Strings to match the `main` argument
		String testOutput = "solutionTestData/SyntaxTestOutput.txt"; // Type is String to match type of `readFile` method 
